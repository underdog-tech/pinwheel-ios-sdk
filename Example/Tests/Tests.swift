...
class PinwheelVCDelegate: PinwheelDelegate {
    public var onEventType: PinwheelEventType?
    ...
    func onEvent(eventType: PinwheelEventType, eventPayload: PinwheelEventPayload?) {
...
//                expect(delegate.onEventType?.name).to(equal("open"))
//            }
//            
...
//                expect(delegate.onEventType?.name).to(equal("select_employer"))
//            }
//            
...
//                expect(delegate.onEventType?.name).to(equal("select_platform"))
//            }
//            
...
//                let pinwheelVC = PinwheelViewController(token: linkToken, delegate: delegate)
//                pinwheelVC.userContentController(userContentController, didReceive: message)
//                expect(delegate.onEventType?.name).to(equal("incorrect_platform_given"))
//            }
//            
...
//                let pinwheelVC = PinwheelViewController(token: linkToken, delegate: delegate)
//                pinwheelVC.userContentController(userContentController, didReceive: message)
//                expect(delegate.onEventType?.name).to(equal("login"))
...
//                let pinwheelVC = PinwheelViewController(token: linkToken, delegate: delegate)
//                pinwheelVC.userContentController(userContentController, didReceive: message)
//                expect(delegate.onEventType?.name).to(equal("login_attempt"))
...
//                let pinwheelVC = PinwheelViewController(token: linkToken, delegate: delegate)
//                pinwheelVC.userContentController(userContentController, didReceive: message)
//                expect(delegate.onEventType?.name).to(equal("input_amount"))
